...
const getRechTod = 'SELECT * FROM public."Recu" ORDER BY id DESC';
const updaterecu =
...
const sumTotalRecu = 'SELECT SUM("Totalrecu") FROM public."Recu"';
const sumPartLivreur = 'SELECT SUM("Partlivreur") FROM public."Recu"';
const sumPartEntreprise = 'SELECT SUM("PartEntreprise") FROM public."Recu"';
const sumCommission = 'SELECT SUM("Commission") FROM public."Recu"';
const sumRecuNet = 'SELECT SUM("RecuNet") FROM public."Recu"';
const sumAvance = 'SELECT SUM("Avance") FROM public."Recu"';
const sumRetour = 'SELECT SUM("Retour") FROM public."Recu"';
const sumLivreur = 'SELECT COUNT(*) FROM public."Recu"';
const getRecuFiche =
